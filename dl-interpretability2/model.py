...
class GPTLightningModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx=0):
        ...
        # For each sequence, find the first error position (if any)
        B, T = idx.shape
            ...
            for ridx in result_indices:
                if not seq_correct[ridx]:
                    ...
                    if self.dataset_type == "position_coupling":
                        first_error_positions.append(seq_pos_ids[ridx].item())
                ...
                # No error found - sequence is correct
        ...
        if len(first_error_positions) > 0:
            ...
            # # Also log the minimum (earliest failure)
            # min_first_error_pos = min(first_error_positions)
            # self.log(
            #     "val_min_first_error_pos",
            #     min_first_error_pos,
            #     on_step=False,
            #     on_epoch=True,
            #     prog_bar=False,
